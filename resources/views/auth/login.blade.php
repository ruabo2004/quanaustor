                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="d-flex gap-2 justify-content-center">
                            <button type="button" class="btn btn-dark btn-sm" onclick="quickLogin('admin@gmail.com', 'admin123')">
                                <i class="fas fa-crown"></i> ADMIN
                            </button>
                            <button type="button" class="btn btn-primary btn-sm" onclick="quickLogin('iezreal.com@gmail.com', 'a123456a')">
